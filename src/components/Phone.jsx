...
export function Phone({ currentScreen, ...props }) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      {currentScreen === "Phone" && (
        <Html
          position={[0.1, 0.15, 0.02]} // Adjust position to fit the screen
          rotation={[0, Math.PI, 0]} // Adjust rotation if necessary
          scale={0.09} // Adjust scale to fit the screen
          transform
        >
          <iframe
